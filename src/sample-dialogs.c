...
/* the website url */
#define PLUGIN_WEBSITE "https://github.com/tcet-opensource"
...
void sample_about(XfcePanelPlugin* plugin) {
    ...
    gtk_show_about_dialog(
        ...
        "1.0.0", "program-name", "XPYTILE", "comments",
        _("This is a sample plugin"), "website", PLUGIN_WEBSITE, "copyright",
        "Copyright \xc2\xa9 2006-2023 The Xfce development team", "authors",
        auth, NULL);
}
